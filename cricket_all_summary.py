...
# Aggregate Report
aggregate_report = f"""
Comprehensive Cricket Observation Data Analysis (17 Western U.S. States, All Observations)
Generated on {datetime.now().strftime('%Y-%m-%d %H:%M:%S')}
================================================================================
...
Total Observations: {total_observations_all}
...
plt.title("Cricket Observations by State")
plt.xlabel("State")
plt.ylabel("Number of Observations")
